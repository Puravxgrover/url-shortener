  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 border p-4 bg-gray-900 rounded-lg">
      ...
      {url?.qr && (
        <img
          src={url.qr}
          className="h-32 w-32 object-contain ring ring-blue-500 self-start bg-white p-2 rounded"
          alt="QR Code"
        />
      )}
      ...
      >
        ...
        <span className="text-2xl text-blue-400 font-bold hover:underline cursor-pointer break-all">
          https://urlshortener-topaz.vercel.app/
        ...
        <Button
          ...
          onClick={() =>
            navigator.clipboard.writeText(
              `https://urlshortener-topaz.vercel.app/${url?.custom_url || url?.short_url}`
            )
          }
        >
          <Copy />
